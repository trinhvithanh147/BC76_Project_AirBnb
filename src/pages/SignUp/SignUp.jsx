...
import SelectCustom from "../../components/SelectCustom/SelectCustom.jsx";
    ...
    onSubmit: (values) => {
      authService
        ...
        .then((res) => {
          ...
          // Delete input
          resetForm();
          // Thẻ Toastify thông báo thành công
          handleNotification("success", "Đăng ký thành công");
          // Đăng ký thành công => page signIn
          setTimeout(() => {
  ...
  return userInfo.user ? (
    ...
    <div className="grid grid-cols-1 lg:grid-cols-2 min-h-screen">
      ...
      <div className="h-screen hidden lg:block">
        <img className="h-full rounded-e-[5%]" src="background_7.jpg" alt="" />
      </div>
      {/* form  */}
      <div className="p-10 flex flex-col justify-center items-center bg-[url(/background_7.jpg)] bg-no-repeat bg-cover bg-center lg:bg-none">
        <div className="bg-white/70 p-10 lg:p-0">
          {/* logo & title form  */}
          <div className="flex flex-col items-center space-y-2 mb-6">
            ...
            <h1 className="font-bold text-2xl uppercase ">ĐĂNG ký</h1>
          </div>
          {/* form  */}
          <form onSubmit={handleSubmit} action="h-full w-full">
            ...
            <ButtonCustom
              buttonContent={"Đăng ký"}
              type={"submit"}
              className={
                "w-full px-5 py-3 text-white font-bold rounded-xl border border-[#C6A3B7] bg-[#C6A3B7] hover:border-[#3F497A] hover:bg-[#3F497A] duration-300"
              }
            />
          </form>
        </div>
